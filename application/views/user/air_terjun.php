...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<body>
		...
		<?php foreach ($wisata as $val) ?>
	<div class="container">
	<img src="<?=base_url('assets2/images/wisata/'.$val['gambar']);?>" width="100%" height="100%" style="display: block; margin: auto;" alt="Free HTML5 Bootstrap Template by FreeHTML5.co" class="img-responsive mb20">

			<div class="row">
				<div class="col-lg-10">
					<br>
					<h3 class="section-title"><?=$val['nama_wisata'];?></h3>
